...
| [手动部署](#手动部署) | 适用于已有免费基础班 1 环境，或计划付费购买腾讯云云开发包年包月环境的的用户。 |
| [命令行部署](#命令行部署) | 仅针对有 Node.js 经验的开发者。 |
| [Vercel 部署](#vercel-部署) | 适用于错过云开发免费活动，想要免费部署的用户。 |
...
``` json
{ "dependencies": { "twikoo-func": "1.4.0-alpha" } }
```
...
4. 点击以下按钮将 Twikoo 一键部署到 Vercel<br>
...
``` html
<div id="tcomment"></div>
<script src="https://cdn.jsdelivr.net/npm/twikoo@1.4.0-alpha/dist/twikoo.all.min.js"></script>
<script>
twikoo.init({
  envId: '您的环境id',
  el: '#tcomment',
